...
void append_page_header() {
  ...
  webpage += F("<head>");
  webpage += F("<title>File Upload Web Server</title>");
  ...
  webpage += F("h1{color:white;border-radius:0em; justify-content: center;font-size:1.5em;padding:0.2em 0.2em;background:#d90707;}");
  ...
  webpage += F(".rcorners_n {border-radius:0.5em;background:#3492eb;padding:0.3em 0.3em;width:20%;color:white;font-size:75%;}");
  webpage += F(".rcorners_m {border-radius:0.5em;background:#3492eb;padding:0.3em 0.3em;width:50%;color:white;font-size:75%;}");
  webpage += F(".rcorners_w {border-radius:0.5em;background:#3492eb;padding:0.3em 0.3em;width:70%;color:white;font-size:75%;}");
  webpage += F(".column{float:left;width:50%;height:45%;}");
  webpage += F(".row:after{content:'';display:table;clear:both;}");
  webpage += F("*{box-sizing:border-box;}");
  webpage += F("a{font-size:75%;}");
  webpage += F("p{font-size:75%;}");
  webpage += F("</style></head><body><h1>File Upload Web Server</h1>");
  webpage += F("<ul>");
